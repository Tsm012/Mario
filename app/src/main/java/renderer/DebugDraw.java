...
public class DebugDraw {
    ...
    private static Shader shader = AssetPool.getShader("assets/shaders/debug_line2D_vertex_shader.glsl", "assets/shaders/debug_line2D_fragment_shader.glsl");
    ...
    private static void rotate(Vector2f center, float rotation, Vector2f vert) {
        float x = vert.x - center.x;
        float y = vert.y - center.y;
    ...
    public static void addCircle(Vector2f center, float radius, Vector3f color, int lifetime) {
        ...
        for (int i=0; i < points.length; i++) {
            ...
            rotate(new Vector2f(), currentAngle, tmp);
